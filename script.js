...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const dDlApps = [
        ...
        { id: 'diamond', name: 'Diamond', platform: 'Android', filename: 'Diamond V4.apk', version: '4.0.0', description: 'The Diamond Company Version 4.0 App.', category: 'Utilities', size: '3.5 MB', year: 2026, dev: 'Diamond', downloads: '100+', rating: 5.0, featured: false, icon: 'assets/applogo.png', features: ['Quantum Encryption', 'Live Monitoring', 'Zero-Latency UI'] },
